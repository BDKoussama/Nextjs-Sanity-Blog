...
export default function AffiliateItem({product}){  
    return (
        <div className='mb-20'>
            ...
            <div className="flex flex-col lg:flex-row h-full justify-between items-start lg:items-start rounded-lg mt-5 bg-violet-50  px-2 py-2 lg:py-5">
                ...
                <div className="ml-0 lg:ml-3 pr-0 lg:pr-2 w-full lg:w-[50%] mt-10 lg:mt-0">
                    ...
                    <div className="mt-10 lg:mb-5">
                        <Link href = {product?.link}>
                            <a className='py-5 px-10 bg-rose-500 rounded-lg !text-white font-medium w-full block lg:inline-block text-center'> Buy From {product?.linkText} </a>
                        </Link>
                    </div>
                </div>
            </div>
